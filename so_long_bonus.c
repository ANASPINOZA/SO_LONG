...
/*   Updated: 2022/07/01 11:15:41 by aadnane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	play_sound(int soundeffect)
{
	...
	{
		if (soundeffect == 1)
			system("afplay ./assets_bonus/CoinSound.wav");
		else if (soundeffect == 2)
			system("afplay ./assets_bonus/mamamia.wav");
		else if (soundeffect == 3)
			system("afplay ./assets_bonus/complet.wav");
		exit(0);
	}
}
